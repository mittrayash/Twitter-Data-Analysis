...
#query = "#DelhiSmog OR #MyRightToBreathe OR #CropBurning OR #AirPollution OR #LetMeBreathe OR #DelhiAirQuality OR #DelhiSmog OR #DelhiPollution OR #OddEven OR #OddEvenScheme OR #SaveDelhiAir OR #DelhiAir"
